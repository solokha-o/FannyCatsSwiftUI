...
//    let link = "https://api.thecatapi.com/v1/breeds"
    ...
    static var catBreedsData : [CatBreedsDataBaseModel] = loadData("https://api.thecatapi.com/v1/breeds")
    // load cat breeds from url and to decode from JSON to CatBreedsDataBaseModel
    static func loadData<T: Decodable>(_ link: String) -> T {
        var data = Data()
